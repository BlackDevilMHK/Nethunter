...
# Copyright ©2021 by BlackDevilMHK. All rights reserved.  🌎 🌍 🌏 🌐 🗺
#
# 
################################################################################
...
finalwork() {
	...
	echo
	axel -a https://github.com/BlackDevilMHK/Nethunter/blob/main/finaltouchup.sh
...
printline
printline
printf "\n${blue} [*] My official email:${yellow}		blackdevilmhk@gmail.com\n"
printf "$blue [*] My facebook:${yellow}		https://faceboook.com/BlackDevilMHK\n"
printf "$blue [*] My YouTube channel:${yellow}	https://youtube.com/channel/UCfRYPIUkuagLYibzF0o6Qgw\n"
printline
printf "$reset"
